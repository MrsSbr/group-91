...
import lab4.src.input.ConsoleInput;
import lab4.src.input.InvalidBoundsException;
import lab4.src.modules.PlantStorage;
...
public class Main {
    ...
    private static final String DATA_PATH = "lab4/data.txt";
