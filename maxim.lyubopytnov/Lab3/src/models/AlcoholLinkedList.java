...
public class AlcoholLinkedList {
    private final boolean timeCheckState;
    private final int ALCOHOL_NOTES_NUM;
    private final List<AlcoholNotes> alcoholNotes = new LinkedList<>();

    AlcoholLinkedList(boolean timeCheckState, int ALCOHOL_NOTES_NUM) {
